...
class TestResultsSummaryDirective(Directive):
    pass
...
def setup(app):
    app.add_directive("my-test-report", TestResultsDirective)
    app.add_directive("my-test-summary", TestResultsSummaryDirective)
