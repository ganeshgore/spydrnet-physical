...
.. image:: ../../../examples/OpenFPGA_tiling/_tile02_floorplan.svg
    :height: 400px
...
from spydrnet_physical.util import FloorPlanViz, Tile02, GridFloorplanGen, OpenFPGA
...
def main():
    ...
    grid_plan.set_column_width(1, 70)
    ...
    dwg.saveas("_tile02_floorplan.svg", pretty=True, indent=4)
