...
class TestFpgaGridGen(unittest.TestCase):
    ...
    def test_add_row_repeat(self):
        ...
        tree = ET.Element("row", attrib={"type": "io_right",
                                         "starty": "H-4",
                                         "startx": "W-4",
                                         "repeaty": "H-2"})
        grid_gen.add_row(tree)
    ...
    def test_add_row_incr(self):
        ...
        tree = ET.Element("row", attrib={
                          'type': "io_right", "starty": "H-4",  "startx": "W-4", "incrx": "W-2", "repeaty": "H-2"})
        grid_gen.add_row(tree)
    ...
    def test_add_col_repeat(self):
        ...
        tree = ET.Element("col", attrib={'type': "io_left",
                                         "startx": "W-4",
                                         "starty": "H-4",
                                         "repeatx": "W-2"})
        grid_gen.add_col(tree)
    ...
    def test_add_col_incr(self):
        ...
        tree = ET.Element("col", attrib={
                          'type': "io_left", "startx": "W-4", "starty": "H-4", "incry": "H-2", "repeatx": "W-2"})
