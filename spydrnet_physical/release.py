...
description = "SpyDrNet Plugin for Physical Design Related Transformations"
license = 'BSD'
authors = {'gore': ('Ganesh Gore', 'ganesh.gore@utah.edu')}
maintainer = "Ganesh Gore (The Laboratory for NanoIntegrated Systems)"
maintainer_email = "ganesh.gore@utah.edu"
url = 'https://ganeshgore.github.io/spydrnet_physical/'
project_urls = {
    "Bug Tracker": "https://github.com/ganeshgore/spydrnet_physical/issues",
    "Documentation": "https://ganeshgore.github.io/spydrnet_physical",
    "Source Code": "https://github.com/ganeshgore/spydrnet_physical",
}
