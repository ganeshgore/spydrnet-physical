...
def main():
    ...
    fpga = FPGAGridGen(
    design_name="FPGA8x4_HETERO",
    arch_file="/home/users/saad.khalil/Documents/RS/spydrnet-physical_des_exam/examples/design_example/FPGA8x4_HETERO/task/arch/vpr_arch.xml",
